...
import com.cafelivro.oslc.Attachment;
import com.cafelivro.oslc.AttachmentSet;
import com.cafelivro.oslc.MaximoConnector;
import com.cafelivro.oslc.Options;
import com.cafelivro.oslc.OslcException;
import com.cafelivro.oslc.QueryWhere;
import com.cafelivro.oslc.Resource;
import com.cafelivro.oslc.ResourceSet;
import com.cafelivro.oslc.SavedQuery;
import com.cafelivro.oslc.Util;
...
public class TestOSLCApi{
	...
	public static void main(String[] args) throws OslcException, IOException,InterruptedException, DatatypeConfigurationException {
		// connection
		Util.jsonPrettyPrinter("*******************connection******************");
		MaximoConnector mc = new MaximoConnector(new Options().user("maxadmin")
				.password("maxadmin").mt(false).lean(true).auth("maxauth")
